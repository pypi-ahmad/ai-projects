...
Two independent, optional detectors for cases Phases 3 to 4's rules can't phrase-match; both off
...
Phases 2 to 4. The live-Ollama checks above were manual smoke tests, not part of this suite (the
