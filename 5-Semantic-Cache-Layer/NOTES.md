...
Semantic Cache Layer: embed the incoming query, nearest-neighbor lookup
against stored queries, return the stored answer on a hit. Track hits,
misses, latency, savings. Exact-key cache alone is not enough — this is
