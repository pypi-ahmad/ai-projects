...
**Requirements:**
- Bring `README.md`, `docs/VALIDATE.md`, `docs/REGIONS.md`, `docs/COMPLIANCE.md`, and `docs/MODEL.md` in line with the actual code.
- Pin `requirements.txt` to the exact versions currently installed/imported.
- State clearly, in the docs: this is not LandingAI ADE or Reducto; cropping is best-effort; math validation plus human review are the control plane — not the model.
