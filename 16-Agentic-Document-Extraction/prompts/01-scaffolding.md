...
**Implement** the project's documentation and file scaffolding. Do not make
model calls in this phase.
...
- `docs/MODEL.md`: `gpt-6-sol`, image in / text out, structured outputs; and that a structured output is not the same as a mathematically correct one.
